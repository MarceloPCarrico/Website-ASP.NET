<%@ Page Title="About" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Editar.aspx.cs" Inherits="EX6.Editar" %>
    ...
    <main class="container mt-5" style="max-width: 1200px; margin: 0 auto; background-color: #333; color: #fff; padding: 20px;">
        ...
        <div class="d-flex justify-content-center flex-column">
            <div class="col-sm-6 text-center mb-3">
                <asp:Button ID="btn_Alterar" runat="server" Text="Alterar" CssClass="btn btn-primary btn-lg" BackColor="Gray" OnClick="btn_alterar_Click"></asp:Button>
            </div>
